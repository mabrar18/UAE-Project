...
st.write("\n\n\n")
st.image("credit cards.jpg", use_column_width="auto")
st.write("Explore a variety of credit cards to find the perfect fit for you. Experience some of the best credit card offers tailored for expatriates living in the UAE and enjoy unmatched privileges and benefits with Real Work Financing Broker CO. \nBy comparing over 150 credit card options available in the UAE, you can select the one that suits your needs best. Apply for a callback from your chosen bank and receive your card within 48 hours through our Smart Finance Credit Card service.")
